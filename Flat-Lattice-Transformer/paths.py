...
yangjie_rich_pretrain_unigram_path = '/mnt/FLAT/data/gigaword_chn.all.a2b.uni.ite50.vec'
yangjie_rich_pretrain_bigram_path = '/mnt/FLAT/data/gigaword_chn.all.a2b.bi.ite50.vec'
yangjie_rich_pretrain_word_path = '/mnt/FLAT/data/ctb.50d.vec'
yangjie_rich_pretrain_char_and_word_path = '/mnt/FLAT/data/yangjie_word_char_mix.txt'
# lk_word_path = '/remote-home/xnli/data/pretrain/chinese/sgns.merge.word'
lk_word_path_2 = '/mnt/FLAT/data/sgns.merge.word_2'
...
resume_ner_path = '/mnt/FLAT/ResumeNER'
